namespace MovieMind.Web.Controllers
{
    ...
    using MovieMind.Web.ViewModels.Account;
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Age = model.Age, Gender = model.Gender, UserCountry = model.Country };
